...
from .alignment_null import NULL_NAME
...
def build_validation_unlock(
        ...
        effects.append(
            {
                ...
                "null_validation_median_pearson_r": null_r,
    ...
    report: dict[str, Any] = {
        ...
        "claim_boundary": (
            "This development gate only authorizes one explicit test evaluation. "
            "It is not a test result and cannot establish a neural-decoding claim."
        ),
    }
