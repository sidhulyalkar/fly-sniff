...
cp "${E001_ROOT}/SUMMARY.txt" "${REPORT_ROOT}/E001-SUMMARY.txt"
...
lines = [
    ...
    "- E001: numerical-calibration metadata and DoOR Stensmyr.2012.WT cross-check remain separate from archive provenance.",
...
It does not:
  ...
  * fit O001 numeric parameters from figure pixels;
