...
class ProgramAEvaluationContract:
    ...
    def _payload_without_hash(self) -> dict[str, Any]:
        ...
        return {
            ...
            "condition_families": [
                family.to_dict()
                for family in sorted(self.condition_families, key=lambda item: item.family_id)
            ],
            "interventions": [
            ...
            "final_seeds_materialized_before_entropy_reveal": (
                self.final_seeds_materialized_before_entropy_reveal
            ),
            "topology_specific_condition_selection_allowed": (
                self.topology_specific_condition_selection_allowed
            ),
