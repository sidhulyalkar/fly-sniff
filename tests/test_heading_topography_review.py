        ...
        "direct_predictions": [
            {
                ...
                "target": "PFL3",
                "edges": [
                    {"source": 1, "target": 10, "source_instance": "EPG(PB08)_R4", "target_instance": "PFL3(PB12c)_R4_C4", "weight": 12.0},
                    {"source": 2, "target": 11, "source_instance": "EPG(PB08)_L3", "target_instance": "PFL3(PB12c)_L3_C5", "weight": 7.0},
                    {"source": 3, "target": 12, "source_instance": "EPG(PB08)_R4", "target_instance": "PFL3(PB12c)_R3_C5", "weight": 14.0}
                ]
            }
        ]
    }
